...
const RegisterModal = ({ setShowModal, setShowRegisterModal }) => {
  ...
  return (
    <>
      <div className="fixed inset-0 text-black z-50 outline-none focus:outline-none flex justify-center items-center">
        <div className="relative flex flex-col bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0 " ref={modalRef}>
          ...
          >
            ...
            <div className="py-4  relative">
              <button className="w-[300px] bg-primary text-white font-inter p-2 rounded-lg mb-3 hover:bg-white hover:text-primary hover:font-inter border">
                Register
              </button>
          ...
          <div className="relative">
            <img
              ...
              alt="img"
              className="w-[300px] bg-black h-full hidden rounded-r-2xl md:block object-cover"
            />
          </div>
        </div>
      </div>
