        ...
        <div ref={modalRef} className="relative flex flex-col bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
          {!showRegisterModal ? (
            <form onSubmit={handleSubmit} className="flex flex-col justify-center items-center gap-3 p-4">
              ...
              <div className="flex text-black flex-col gap-2 w-full relative">
              ...
              <div className="flex flex-col text-black gap-2 w-full relative">
              ...
              <div className="flex text-black justify-center items-center py- font-inter hover:text-primary">
                <button
                  type="button"
          ...
          {!showForgetPassword && (
            <div className="relative">
              <img  alt="img" className="w-[300px] bg-black h-[450px] hidden rounded-r-2xl md:block object-cover" />
            </div>
          )}
        </div>
      </div>
