...
const Header = () => {
  ...
  return (
    <header className="header">
      ...
      {showModal && <LoginModal setShowModal={setShowModal} setShowRegisterModal={setShowRegisterModal} />}
      {showRegisterModal && <RegisterModal setShowModal={setShowModal} setShowRegisterModal={setShowRegisterModal} />}
    </header>
  );
};
